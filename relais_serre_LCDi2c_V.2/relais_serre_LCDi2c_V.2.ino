...
//Rollup:
#define TEMP_ROLLUP 20 //température d'activation des rollup
#define HYST_ROLLUP 2
...
//Chauffage:
#define TEMP_CHAUFFAGE1 18  //température d'activation de la 1re fournaise
#define HYST_CHAUFFAGE1 2   
#define TEMP_CHAUFFAGE2 15  //température d'activation de la 2e fournaise
#define HYST_CHAUFFAGE2 2

//incréments d'ouverture(nombre d'incréments d'ouverture = PCT_OPEN/NB_OF_STEPS_IN_ANIMATION = 25/5 = 5 incréments d'ouverture)
#define PCT_OPEN 25
#define NB_OF_STEPS_IN_ANIMATION 5 //doit être un divisible de PCT_OPEN

//temps de rotation et pauses
#define ROTATION_TIME 4000 //temps de rotation des moteurs(en mili-secondes)
#define PAUSE_TIME 2000 //temps d'arrêt entre chaque ouverture/fermeture(en mili-secondes)
#define SLEEPTIME 1000 //temps de pause entre chaque exécution du programme(en mili-secondes)

//*************FIN DU BLOC PROGRAMMABLE**********

//Entrées
#define THERMOMETER_IN A0 // sonde de température DHT11
//Sorties
